/* @robot_full_class Inatto\Turism\Third\Voetur\BuscaAereo */
/* @robot_update true */
...
class class__0000000000 {
    ...
    constructor() {
        this.autoComplete($(".Inatto_Turism_Third_Voetur_BuscaAereo"));
    }
    ...
    autoComplete($c) {
        ...
        $c.find("input[type=text]").autocomplete({
            noCache: false,
            serviceUrl: root + '/admin/autocomplete?type=autoCompleteAero', // ex: /int/admin/autocomplete
            ...
            onSelect: function (item) {
                ...
                let $divHelperForm = $(this).closest(".Inatto_Turism_Third_Voetur_BuscaAereo");
                let idValue = item['id'];
